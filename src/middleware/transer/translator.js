export default new Map([
    ...
    ['MINUS_ATTACK_TIMES', 'MINUS_E_ATTACK_TIMES'],
    ['REFRESH_ATTACK_TIMES', 'REFRESH_E_ATTACK_TIMES'],
    ['REDUCE_HP', 'REDUCE_E_HP'],
    ['REDUCE_E_HP', 'REDUCE_HP'],
    ['DELETE_HANDCARDS', 'DELETE_E_HANDCARDS'],
